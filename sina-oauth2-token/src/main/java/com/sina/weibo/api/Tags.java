...
public class Tags extends Weibo {
	...
	public List<Tag> destroyTagsBatch(String ids) throws WeiboException {
		return Tag.constructTags(client.post(WeiboConfig.getValue("baseURL") + "tags/destroy_batch.json",
	 ...
	 * @since JDK 1.5
	 */
	public List<Tag> getTags(String uid, String accessToken) throws WeiboException {
		return Tag.constructTags(client.get(WeiboConfig.getValue("baseURL") + "tags.json", new PostParameter[] {
	...
	public List<Tag> getTags(String uid, Paging page) throws WeiboException {
		return Tag.constructTags(client.get(WeiboConfig.getValue("baseURL") + "tags.json",
	 ...
	 * @since JDK 1.5
	 */
	public List<TagWapper> getTagsBatch(String uids, String accessToken) throws WeiboException {
		return Tag.constructTagWappers(client.get(WeiboConfig.getValue("baseURL") + "tags/tags_batch.json",
						new PostParameter[] { new PostParameter("access_token", accessToken),
								new PostParameter("uids", uids) }, false));
	}
